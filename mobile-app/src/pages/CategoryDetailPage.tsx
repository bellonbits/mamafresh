  ...
  if (!category) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-[#F4F6F5] p-6 text-center">
        <p className="text-lg font-black text-gray-800">Category not found</p>
        <Link href="/categories" className="rounded-full bg-[#073729] px-5 py-2.5 text-xs font-bold text-white">Browse categories</Link>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-500">
                {loading ? "Loading..." : `${products.length} fresh products ready for 30-min delivery`}
              </p>
            </div>
            <Link
              href="/shops"
