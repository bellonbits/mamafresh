        ...
        <div className="w-full space-y-3 lg:hidden">
          ...
          <nav className="divide-y divide-slate-100 overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
            ...
            {seller && (
              <Link
                href="/deliver"
                className="flex w-full items-center justify-between px-4 py-3.5 text-left text-sm font-semibold text-[#16A34A]"
              >
                <span className="flex items-center gap-3"><Navigation size={17} /> My Deliveries</span>
          ...
          <div>
            ...
            <nav className="space-y-1">
              ...
              {seller && (
                <Link
                  href="/deliver"
                  className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-[#16A34A] hover:bg-emerald-50/60"
                >
                  <Navigation size={17} />
                  {!sidebarCollapsed && <span>My Deliveries</span>}
                </Link>
              )}
            </nav>
          </div>
