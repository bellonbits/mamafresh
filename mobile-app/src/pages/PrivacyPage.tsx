...
export default function PrivacyPage() {
  return (
    <div className="bg-[#F7F8F6] pb-28 animate-fade-in">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <p className="mt-1">
              ...
              faster. You control the optional kind through the cookie banner shown on first visit, or your device settings at any time.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1.5 pl-5">
              ...
              <li>Turn off optional cookies/local storage via the cookie banner or your device settings.</li>
